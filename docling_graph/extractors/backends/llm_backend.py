...
class LlmBackend:
    ...
    def __init__(self, llm_client: BaseLlmClient):
        ...
        print(f"[LlmBackend] Initialized with client: [cyan]{self.client.__class__.__name__}[/cyan]")
    ...
    def extract_from_markdown(self, markdown: str, template: Type[BaseModel], 
        ...
        """
        print(f"[LlmBackend] Extracting from {context} ([cyan]{len(markdown)}[/cyan] chars)")
        ...
        try:
            ...
            try:
                ...
                print(f"[LlmBackend] Successfully extracted data from {context}")
                return validated_model
                
            except ValidationError as e:
                # Detailed error reporting
                print(f"[LlmBackend] [yellow]Validation Error for {context}:[/yellow]")
