...
@patch("docling_graph.llm_clients.gemini.types")
@patch("docling_graph.llm_clients.gemini.get_context_limit")
def test_get_json_response_dict_prompt(mock_get_context_limit, mock_types, mock_genai, mock_env_vars):
    ...
    result = client.get_json_response(
        prompt={"system": "Extract info", "user": "Process this"},
        schema_json="{}"
    )
...
@patch("docling_graph.llm_clients.gemini.types")
@patch("docling_graph.llm_clients.gemini.get_context_limit")
def test_get_json_response_string_prompt(mock_get_context_limit, mock_types, mock_genai, mock_env_vars):
...
@patch("docling_graph.llm_clients.gemini.types")
@patch("docling_graph.llm_clients.gemini.get_context_limit")
def test_get_json_response_list_result(mock_get_context_limit, mock_types, mock_genai, mock_env_vars):
...
@patch("docling_graph.llm_clients.gemini.types")
@patch("docling_graph.llm_clients.gemini.get_context_limit")
def test_get_json_response_scalar_result(mock_get_context_limit, mock_types, mock_genai, mock_env_vars):
...
@patch("docling_graph.llm_clients.gemini.types")
@patch("docling_graph.llm_clients.gemini.get_context_limit")
def test_get_json_response_invalid_json(mock_get_context_limit, mock_types, mock_genai, mock_env_vars):
